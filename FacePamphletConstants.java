...
public interface FacePamphletConstants {
    ...
    /**
     * Text to be used to create an "empty" label to put space
     * between HomePage and other interactors on North border of application(Extension)
     */
    public static final String EMPTY_LABEL_TEXT_NORTH = "         ";
    ...
    /**
     * The number of pixels of y coordinate of GImage/GRect,
     * which displays photo of user. This coordinate will never
     * change, because label of name above always has height of
     * 25(since font is "Dialog-24"), and Margins are themselves
     * constants
     */
    public static final double IMAGE_Y_COORDINATE = IMAGE_MARGIN + TOP_MARGIN + 25;
